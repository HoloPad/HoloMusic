...
class _RegisterViewState extends State<RegisterView> {
  ...
  Future onRegisterClick() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final response = await UserRequest.register(email, username, password);
            ...
            child: Column(
              children: [
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  Text(
                    AppLocalizations.of(context)!.userSignup,
                ...
                Form(
                    ...
                    child: Column(children: [
                      ...
                      TextFormField(
                        style: AppStyle.textStyle,
                        decoration:
                            generateInputDecoration("Username", _errorMap[fieldsIds[_usernameId]]),
                ...
                _isLoading
                    ...
                    : CommonComponents.generateButton(
                        text: AppLocalizations.of(context)!.signup, onClick: onRegisterClick),
                const SizedBox(height: 15),
              ],
            ),
          ),
